...
@endif
    ...
    <input type="text" name="cumprimento" value="{{ $produto_detalhe->cumprimento ?? old('cumprimento')}}" placeholder="comprimento" class="borda-preta">
    {{$errors->has('cumprimento') ? $errors->first('cumprimento') : ''}}
